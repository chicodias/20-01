...
barplot(freqb)
```
##### Resp c: Os dados parecer ter distribuição normal, porém seria necessário um teste de aderência (tentar ks.test(dados.ex14_6,y="pnorm",mean=10,sd=5) ) para comprovar essa hipótese. As frequencias tem uma distribuição similar entre si, sendo a média dos acidentes com cinto durante a tarde, enquanto os acidentes sem cinto ocorrem em média durante a madrugada. 
